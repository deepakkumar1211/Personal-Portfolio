...
// 									{/* <h1 className="text-[56px] sm:text-inherit text-center font-Poppins leading-[75px]" >{hero.middleName}</h1> */}
// 									<h1 className="text-[56px] sm:text-inherit text-center font-Poppins leading-[75px]" >{hero.LastName}</h1>
// 								</span>
// 							</h1>
// 						</div>
// 					</div>
			...
			<div className="relative flex laptop:flex-row flex-col justify-around items-center">
				...
				<div className="pb-1 pt-5 mt-10 laptop:pl-10 w-auto flex flex-col">
					<div className='flex flex-col justify-between items-center w-full p-1'>
						...
						<div className="flex flex-col w-full items-center">
							<h1 className="text-dark_primary font-Poppins text-[56px] leading-[70px] sm:flex sm:justify-center sm:gap-2 sm:items-center">
								{/* First and Middle Name */}
								<span className="sm:inline-block block">{hero.firstName}</span>
								<span className="sm:inline-block block">{hero.middleName}</span>
							</h1>
							{/* Last Name */}
							<h1 className="text-dark_primary font-Poppins text-[56px] leading-[70px] text-center mt-2">
								{hero.lastName}
							</h1>
						</div>
					</div>
