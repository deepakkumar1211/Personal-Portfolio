...
const Skills = () => {
  return (
    <section id="skills" className="sm:mb-0 sm:px-16 px-6 py-4 pt-14">
      ...
      transition={{ duration: 1, type: 'spring', stiffness:"120"}}
      className="flex-1 font-Poppins font-semibold text-[35px] sm:text-[45px] leading-[80px] text-white text-center">
        Skills
      </motion.h1>
      ...
      >
        ...
        <motion.div className={`ml-4 mb-6 flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6`}>
